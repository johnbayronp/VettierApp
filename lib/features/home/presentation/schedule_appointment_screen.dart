...
class ScheduleAppointmentScreen extends StatefulWidget {
  ...
  const ScheduleAppointmentScreen({Key? key, required this.clinic}) : super(key: key);
...
class _ScheduleAppointmentScreenState extends State<ScheduleAppointmentScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final userPets = pets.where((pet) => pet['ownerId'] == 'user1').toList(); // Obtener mascotas del usuario 1
                ...
                child: Column(
                  ...
                  children: [
                     ...
                     _buildDropdownField(
                       ...
                       items: doctors.map((doctor) => doctor['name'] ?? 'Sin nombre').cast<String>().toList(),
                       onChanged: (value) => setState(() => selectedVeterinarian = value),
                     ),
                     ...
                     _buildDropdownField(
                       label: 'Mi mascota',
                       value: selectedPet,
                       items: userPets.map((pet) => pet['name'] ?? 'Sin nombre').cast<String>().toList(),
                    ...
                    Wrap(
                      ...
                      children: availableTimes.map((time) {
                        ...
                        final isAvailable = time != '11:00 AM'; // Simular horario no disponible
  ...
  Widget _buildVeterinarianCard(String veterinarianName) {
    ...
    final doctor = doctors.firstWhere(
      ...
      orElse: () => {'name': 'Sin nombre', 'specialty': 'Sin especialidad', 'photoURL': ''},
    );
